...
// File: pg_6povermpmmp.pov
// Vers: 3.7
// Desc: pov file for axial rendering of point group pg_6povermpmmp
// Date: 09/19/2018
// Auth: Marc De Graef
#version 3.7;
global_settings {
...
#declare orbit=
  union {
	  ...
	  object {  pmarrow() scale <1,-1,1>  rotate z*theta rotate y*-300  translate <  0.5 * px + 0.866 * mpy , pz, -0.866 * px + 0.5 *  py > }
