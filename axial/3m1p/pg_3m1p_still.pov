...
// File: pg_3m1p.pov
// Vers: 3.7
// Desc: pov file for axial rendering of point group pg_3m1p
// Date: ../../19/2018
// Auth: Marc De Graef
#version 3.7;
global_settings {
...
#declare orbit=
  union {
	...
	object {  pparrow() rotate z*theta translate < px,pz,msy>  rotate y*120} 

	object {  pparrow() rotate z*theta translate < px, pz,sy>  rotate y*240} 
	object {  pparrow() rotate z*theta translate < px,pz,msy>  rotate y*240} 
