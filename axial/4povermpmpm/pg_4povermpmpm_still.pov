...
// File: pg_4povermpmpm.pov
// Vers: 3.7
// Desc: pov file for axial rendering of point group pg_4povermpmpm
// Date: 09/19/2018
// Auth: Marc De Graef
#version 3.7;
global_settings {
...
#declare orbit=
  union {
	...
	object {  pmarrow() scale <1,-1,1> rotate z*theta translate < px,  pz,  sy> rotate y*90 }
