...
// File: pg_bar4p.pov
// Vers: 3.7
// Desc: pov file for axial rendering of point group pg_bar4p
// Date: 09/19/2018
// Auth: Marc De Graef
#version 3.7;
global_settings {
...
#declare orbit=
  union {
	...
	object {  mmarrow() scale <1,-1,1> rotate z*theta rotate y*90 translate <mpy, mpz,  px> }
	object {  mmarrow() scale <1,-1,1> rotate z*theta rotate y*270 translate < py, mpz, mpx> }
  }
