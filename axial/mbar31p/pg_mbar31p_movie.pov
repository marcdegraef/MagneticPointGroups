...
// File: pg_mbar31p.pov
// Vers: 3.7
// Desc: pov file for axial rendering of point group pg_mbar31p
// Date: 09/19/2018
// Auth: Marc De Graef
#version 3.7;
global_settings {
...
#declare orbit=
  union {
	...
	object {  pparrow() scale <1,-1,1> rotate z*theta translate <mpx, mpz, msy> }
	object {  pparrow() rotate z*-theta Axis_Rotate_Trans(<1, 1, 1>, -120.0) translate < pz,  sy, mpx> }
	object {  pparrow() rotate z*theta Axis_Rotate_Trans(<1, 1, 1>, -240.0) translate <msy,  px,  pz> }
	object {  pparrow() scale <1,-1,1> rotate z*theta rotate y*180.0 translate < px, mpz,  sy> }
	object {  pparrow() rotate z*-theta rotate y*180.0 Axis_Rotate_Trans(<1, 1, 1>, -120.0) translate < pz, msy,  px> }
	object {  pparrow() rotate z*theta rotate y*180.0 Axis_Rotate_Trans(<1, 1, 1>, -240.0) translate < sy, mpx,  pz> }
	object {  pparrow() scale <1,-1,1> rotate z*theta rotate z*180.0 translate < px,  pz, msy> }
	object {  pparrow() rotate z*-theta rotate z*180.0 Axis_Rotate_Trans(<1, 1, 1>, -120.0) translate <mpz,  sy,  px> }
	object {  pparrow() rotate z*theta rotate z*180.0 Axis_Rotate_Trans(<1, 1, 1>, -240.0) translate <msy, mpx, mpz> }
	object {  pparrow() scale <1,-1,1> rotate z*theta rotate x*180.0 translate <mpx,  pz,  sy> }
	object {  pparrow() rotate z*-theta rotate x*180.0 Axis_Rotate_Trans(<1, 1, 1>, -120.0) translate <mpz, msy, mpx> }
	object {  pparrow() rotate z*theta rotate x*180.0 Axis_Rotate_Trans(<1, 1, 1>, -240.0) translate < sy,  px, mpz> }
  }
