...
// File: pg_4overm1p.pov
// Vers: 3.7
// Desc: pov file for axial rendering of point group pg_4overm1p
// Date: 09/19/2018
// Auth: Marc De Graef
#version 3.7;
global_settings {
...
#declare orbit=
  union {
	...
	object {  pparrow() scale <1,-1,1> rotate z*-theta translate < px, mpz,py> rotate y*90} 
	object {  pparrow() scale <1,-1,1> rotate z*-theta translate < px, mpz,py> rotate y*180} 
	object {  pparrow() scale <1,-1,1> rotate z*-theta translate < px, mpz,py> rotate y*270} 
  }
