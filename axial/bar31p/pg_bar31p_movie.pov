...
// File: pg_bar31p.pov
// Vers: 3.7
// Desc: pov file for axial rendering of point group pg_bar31p
// Date: 09/19/2018
// Auth: Marc De Graef
#version 3.7;
global_settings {
...
#declare orbit=
  union {
	...
	object {  pparrow() scale <1,-1,1> rotate z*theta rotate y*-120 translate < -0.5 *mpx - 0.866 *mpy , mpz,  0.866 *mpx - 0.5 *mpy > }
	object {  pparrow() scale <1,-1,1> rotate z*theta rotate y*-240 translate < -0.5 *mpx + 0.866 *mpy , mpz, -0.866 *mpx - 0.5 *mpy > }
  }
