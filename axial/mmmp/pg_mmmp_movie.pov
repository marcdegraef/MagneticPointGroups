...
// File: pg_mmmp.pov
// Vers: 3.7
// Desc: pov file for axial rendering of point group pg_mmmp
// Date: 09/19/2018
// Auth: Marc De Graef
#version 3.7;
global_settings {
...
union {
	...
	object {  anti_axis_two()  rotate x*90.0 rotate y*90}
...
#declare orbit=
  union {
	...
	object {  mmarrow() scale <1,-1,1> rotate z*theta translate <mpx, mpz, -sy> }
