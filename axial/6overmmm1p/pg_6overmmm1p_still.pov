...
// File: pg_6overmmm1p.pov
// Vers: 3.7
// Desc: pov file for axial rendering of point group pg_6overmmm1p
// Date: 09/19/2018
// Auth: Marc De Graef
#version 3.7;
global_settings {
...
#declare orbit=
  union {
	...
	object {  pparrow() rotate z*theta rotate y*-300  translate <  0.5 * px + 0.866 * py , pz, -0.866 * px + 0.5 *  py > }
        ...
        object {  pparrow() rotate z*theta translate < px,  pz, mpy> }
        object {  pparrow() rotate z*theta rotate y*-60 translate <  0.5 * px - 0.866 *mpy ,  pz,  0.866 * px + 0.5 *mpy > }
        object {  pparrow() rotate z*theta rotate y*-120 translate < -0.5 * px - 0.866 *mpy ,  pz,  0.866 * px - 0.5 *mpy > }
        object {  pparrow() rotate z*theta rotate y*-180 translate <mpx,  pz,  py> }
        object {  pparrow() rotate z*theta rotate y*-240 translate < -0.5 * px + 0.866 *mpy ,  pz, -0.866 * px - 0.5 *mpy > }
        object {  pparrow() rotate z*theta rotate y*-300 translate <  0.5 * px + 0.866 *mpy ,  pz, -0.866 * px + 0.5 *mpy > }
        ...
        object {  pparrow() scale <1,-1,1> rotate z*-theta rotate y*-180 translate <mpx, mpz, mpy> }
